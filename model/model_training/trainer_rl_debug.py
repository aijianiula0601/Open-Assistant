...
# os.environ["WANDB_API_KEY"] = '7ff89b003e5eca23bb509352715bf0ac6de83d69'  # 将引号内的+替换成自己在wandb上的一串值
...
def argument_parsing(notebook=False, notebook_args=None, **kwargs):
    ...
    parser.add_argument("--wandb-entity", type=str, default="open-assistant-hjh")
...
def main():
    # import wandb
    # wandb.login(key='7ff89b003e5eca23bb509352715bf0ac6de83d69')
    ...
    import json, copy
    train = json.load(open("/mnt/cephfs/hjh/train_record/nlp/open-assistant/dataset/debug_my_rl.json"))
    ...
    eval_prompts = [
                       "".join(
                           format_pairs(["Can you tell me about GLaDOS?"], eos_token, add_initial_reply_token=True)),
                       "".join(format_pairs(["What is the chemical symbol for gold?"], eos_token,
